...
# # save to csv
#write_csv(adjectives, "adjectives.csv")
#write_csv(rent, "rent.csv")
#write_csv(rent_title_words, "rent_title_words.csv")

# df_plot = rent_title_words %>% 
...
# save 
ggsave("rental_prices.png", p, width = 8, height = 6, dpi = 300)
